...
real_path = "Real_Datasets/Adult_dataset.csv"
...
synthesizer = FCTGAN(dataset="CreditRisk",
                     ...
                     problem_type={"Classification": 'income'},epochs=150)  # Adjust to your problem type
...
joblib.dump(synthesizer, 'fctgan_model_adult.pkl')
